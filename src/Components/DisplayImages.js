    ...
    return (
        <div className="container" style={{backgroundColor: '#174665', height: 850, maxWidth: 'none',}}>
          <div className="row g-5">
            ...
            <img src={banner1} alt="banner1" style={{position: 'absolute', left: 93, top: 164, width: 761, height: 761}} />
            ...
            <img src={banner2} alt="banner2" style={{position: 'absolute', width: 761, height: 761, top: 164}} />
            </div>
          </div>
        </div>
      );
